...
import {
  handleSmallerCursorEnter,
  handleCursorLeave,
} from "../utils/cursorHandlers";
  ...
  return (
    <section id="work" className="app-showcase" ref={sectionRef}>
      <div className="w-full">
        <h2 className="text-showcase">
          Selected <span className="lowercase italic">Projects</span>
        </h2>
        <div className="showcaselayout">
          ...
          <div className="first-project-wrapper" ref={project1Ref}>
            <div
              ...
              onMouseEnter={handleSmallerCursorEnter}
            ...
            <div className="text-content">
              ...
              <p className="text-black md:text-xl">
                A smooth and magical parallax scrolling experience of a fairy
                forest, powered by GSAP animations and clean web technologies.
              </p>
            </div>
          </div>
          {/*RIGHT*/}
